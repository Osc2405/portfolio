    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <ValidationError 
                ...
                errors={state.errors}
            />
            <label htmlFor="message" className='block mt-2 mb-2 text-sm font-medium text-white'>
                Message
            </label>
            <textarea
                id="message"
            ...
            <ValidationError 
                ...
                errors={state.errors}
            />
            <button type="submit" disabled={state.submitting} className="text-white  mt-5  focus:ring-4  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-teal-600 hover:bg-teal-700 focus:ring-teal-800 ">
                Send
            </button>
        </form>
        </>
